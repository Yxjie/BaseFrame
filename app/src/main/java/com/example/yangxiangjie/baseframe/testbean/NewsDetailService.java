...
public interface NewsDetailService {
    ...
    @GET("api/4/news/{id}")
    Observable<NewsDetail> getNewsDetails(@Path("id") long id);

    @GET
    Observable<NewsDetail> getNewsDetails(@Url String url);
    ...
    class NewsDetail {
        ...
        public String toString() {
            return "[title:" + getTitle() + " image_source:" + getImage_source() + " id:" + getId() + "]";
        }

 ...
 * <li>you can change preference authorName by {@link #PREFERENCE_NAME}</li>
 * </ul>
 * <ul>
...
public class PreferencesUtils {
    ...
    public static final String PREFERENCE_NAME = "TrineaAndroidCommon2";

    /**
     * put string preferences
     *
     * @param context
     * @param key     The authorName of the preference to modify
     ...
     *
     * @param context
     * @param key     The authorName of the preference to retrieve
     * @return The preference value if it exists, or null. Throws ClassCastException if there is a preference with this
     * authorName that is not a string
     ...
     * this authorName that is not a string
     */
     ...
     * @param defaultValue Value to return if this preference does not exist
     * @return The preference value if it exists, or defValue. Throws ClassCastException if there is a preference with
     * this authorName that is not a int
     */
     ...
     * @param defaultValue Value to return if this preference does not exist
     * @return The preference value if it exists, or defValue. Throws ClassCastException if there is a preference with
     * this authorName that is not a long
     */
     ...
     * @param key     The authorName of the preference to retrieve
     * @return The preference value if it exists, or -1. Throws ClassCastException if there is a preference with this
     * authorName that is not a float
     ...
     * @param defaultValue Value to return if this preference does not exist
     * @return The preference value if it exists, or defValue. Throws ClassCastException if there is a preference with
     * this authorName that is not a float
     */
     ...
     * authorName that is not a boolean
     ...
     * @param defaultValue Value to return if this preference does not exist
     * @return The preference value if it exists, or defValue. Throws ClassCastException if there is a preference with
     * this authorName that is not a boolean
     */
